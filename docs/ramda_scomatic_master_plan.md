...
Per-cell burden or replication-state summaries may still enter through `dna_cell_summary.tsv` or a future `dna_cnv_summary.tsv` generated by external DNA/CNV pipelines.
...
- MuData interoperability figure:
  - `rna`, `circ`, validated `cnv`, optional exploratory `candidate_snv`
  - shared `obs` schema
