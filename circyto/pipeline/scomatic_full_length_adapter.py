...
def prepare_scomatic_input(
    *,
    ...
    limitations = [
        "SComatic outputs are RNA-derived candidate variant signals, not validated somatic mutations.",
...
def run_scomatic(
    *,
    ...
    plan_lines = [
        ...
        "# Outputs remain RNA-derived candidate variant signals, not validated somatic mutations.",
    ]
    ...
    summary = {
        ...
        "limitations": [
            ...
            "circyto records and imports SComatic outputs; it does not validate DNA somatic mutations.",
        ],
    }
