...
def full_length_circrna(
    ...
    gene_expression_method: str = typer.Option("none", "--gene-expression-method", help="[EXPERIMENTAL] Gene-expression method: none|simple-overlap. Planned future methods: featurecounts|velocyto"),
...
def smartseq3_ciri3(
    ...
    gtf: Path | None = typer.Option(None, "--gtf", exists=True, help="[EXPERIMENTAL] Optional GTF/GFF for CIRI3 and host-gene annotation"),
