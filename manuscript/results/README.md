...
| --- | --- | ---: | --- |
| `mudata_inventory.tsv` | `scripts/manuscript/summarize_mudata_inventory.py` | 3 x 13 | Modality inventory, cell overlap, circRNA feature counts, and host-gene recovery. |
